...
export type TechnicianProfileWhereInput = {
  ...
  technicianId?: Prisma.StringFilter<"TechnicianProfile"> | string
  ...
  experience?: Prisma.StringNullableFilter<"TechnicianProfile"> | string | null
...
export type TechnicianProfileScalarWhereWithAggregatesInput = {
  ...
  technicianId?: Prisma.StringWithAggregatesFilter<"TechnicianProfile"> | string
  ...
  experience?: Prisma.StringNullableWithAggregatesFilter<"TechnicianProfile"> | string | null
...
export type TechnicianProfileOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"technicianId" | "user_id" | "bio" | "location" | "experience" | "rating" | "isAvailable", ExtArgs["result"]["technicianProfile"]>
...
export interface TechnicianProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const technicianProfileWithTechnicianIdOnly = await prisma.technicianProfile.findMany({ select: { technicianId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many TechnicianProfiles and only return the `technicianId`
   * const technicianProfileWithTechnicianIdOnly = await prisma.technicianProfile.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more TechnicianProfiles and only return the `technicianId`
   * const technicianProfileWithTechnicianIdOnly = await prisma.technicianProfile.updateManyAndReturn({
   *   select: { technicianId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TechnicianProfileFieldRefs {
  readonly technicianId: Prisma.FieldRef<"TechnicianProfile", 'String'>
